...
class Colorpicker {
  ...
  generateDOM () {
    ...
    this.displayBoxDomBg = document.createElement("div");
    this.displayBoxDomBg.classList.add(classname("display-box-bg"));
    this.displayBoxDom.appendChild(this.displayBoxDomBg);
   ...
   */
  updateGraphics () {
    this.displayBoxDomBg.style.backgroundColor = this.current.string;
